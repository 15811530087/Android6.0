...
public class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            app.getInvariantDeviceProfile().setLandValue(getApplicationContext());
            mDeviceProfile = app.getInvariantDeviceProfile().landscapeProfile;
            String strTest = String.format("screen first orientation land  !!!!!!!!!!!!!!!!!!!!!!!!!");
            Log.i(TAG,strTest);
        }else{
            app.getInvariantDeviceProfile().setPortValue(getApplicationContext());
            mDeviceProfile = app.getInvariantDeviceProfile().portraitProfile;
            String strTest = String.format("screen first orientation port  !!!!!!!!!!!!!!!!!!!!!!!!!");
            Log.i(TAG,strTest);
        }
        String strTest2= String.format("Screen width= %f ,Height= %f  rows=%d Columns=%d   iconSize=%f ,iconSizePx=%d,iconTextSize=%d,cellWidth=%d cellHeight=%d!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!",
         app.getInvariantDeviceProfile().minWidthDps,app.getInvariantDeviceProfile().minHeightDps,app.getInvariantDeviceProfile().numRows,app.getInvariantDeviceProfile().numColumns,app.getInvariantDeviceProfile().iconSize,
         mDeviceProfile.iconSizePx,mDeviceProfile.iconTextSizePx,mDeviceProfile.cellWidthPx,mDeviceProfile.cellHeightPx);
        Log.i(TAG,strTest2);
    ...
    private int mapConfigurationOriActivityInfoOri(int configOri) {
        ...
        //wh 2018.10.26
        String strTest = String.format("screen orientation %s !!!!!!!!!!!!!!!!!!!!!!!!!",
                (getResources().getConfiguration().orientation==Configuration.ORIENTATION_LANDSCAPE)?"land Profile":"port Profile");
        Log.i(TAG,strTest);
        LauncherAppState app = LauncherAppState.getInstance();
    ...
    public void lockScreenOrientation() {
        Log.i(TAG,"screen lock orientation !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        if (mRotationEnabled) {
